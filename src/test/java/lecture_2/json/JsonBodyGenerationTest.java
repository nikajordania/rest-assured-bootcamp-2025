...
//                .put("photoUrls", new String[]{"string"})
    ...
    public void testObjectMapping() {
        ...
        assertThat(supportObject.getString("url"), equalTo("https://contentcaddy.io?utm_source=reqres&utm_medium=json&utm_campaign=referral"));
        assertThat(supportObject.getString("text"), equalTo("Tired of writing endless social media content? Let Content Caddy generate it for you."));
    }
}
